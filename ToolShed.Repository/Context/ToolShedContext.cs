...
namespace ToolShed.Repository.Context
{
    public class ToolShedContext : DbContext
    {
        ...
        public virtual DbSet<OrderRecord> OrderRecordSet { get; set; }
        ...
        public virtual DbSet<TenantUser> TenantUserSet { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderRecord>().ToTable("OrderRecord")
                .HasKey(c => c.OrderRecordId);
            ...
            modelBuilder.Entity<Tenant>().ToTable("Tenant")
                .HasKey(c => c.TenantId);
            modelBuilder.Entity<TenantUser>().ToTable("TenantUser")
                .HasKey(c => c.TenantUserId);
